  ...
  <div class="bg-gradient-to-b from-gray-900 via-red-800 to-red-600 py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 pb-8 sm:pb-12 px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white rounded-xl shadow-xl p-6 sm:p-8 flex flex-col justify-between transform transition-all duration-300 hover:-translate-y-2">
        ...
        <div class="mt-auto">
          <router-link to="/business-internet" class="btn-gradient-purple">
            Learn More
          </router-link>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-xl p-6 sm:p-8 flex flex-col justify-between transform transition-all duration-300 hover:-translate-y-2">
        ...
        <div class="mt-auto">
          <router-link to="/business-wifi" class="btn-gradient-blue">
            Learn More
          </router-link>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-xl p-6 sm:p-8 flex flex-col justify-between transform transition-all duration-300 hover:-translate-y-2">
        ...
        <div class="mt-auto">
          <router-link to="/business-voice" class="btn-gradient-red">
            Learn More
          </router-link>
        </div>
      </div>
...
.btn-gradient-blue {
  ...
  color: white;
  box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);
  background: linear-gradient(to right, rgb(96, 165, 250), rgb(6, 182, 212));
  transition: background 150ms ease-in-out;
}
...
.btn-gradient-red:hover {
  background: linear-gradient(to right, rgb(220, 38, 38), rgb(190, 24, 93));
}
